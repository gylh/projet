                            ...
                            <div class="col-md-4" id="<?= $product['id'] ?>">
                                <div class="card mb-4 product-wap rounded-0">
                                    <div class="card rounded-0">
                                        <img class="card-img rounded-0 img-fluid" src="admin/imageProduit/<?= $product['photo'] ?>">
                                        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                            <ul class="list-unstyled">
                                                ...
                                                <li><a class="btn btn-success text-white mt-2" href="cartManager.php?id=<?= $product['id'] ?>"><i class="fas fa-cart-plus"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <a href="shop-single.php?id=<?= $product['id'] ?>" class="h3 text-decoration-none"><?= $product['nom'] ?></a>
                                        ...
                                        <p class="text-center mb-0"><?= $product['prix'] ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php
